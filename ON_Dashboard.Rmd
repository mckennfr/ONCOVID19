...
# TODO need to integrate ontario data in here
df$confirmed <- 4038L 
df$death <- 119L
...
# TODO integrate ontario data here
df_daily <- rbind(df_daily,
                  list(date = as.Date("2020-04-05"), 
                       confirmed = 408L,
                       death = 25L,
                       active = 383L,
                       confirmed_cum = 4038L,
...
# TODO need to integrate ontario data
df1$cases[df1$Province.State == "Ontario" & df1$type == "confirmed"] <- 408L
df1$cases[df1$Province.State == "Ontario" & df1$type == "death"] <- 25L
...
# TODO need to integrate Ontario data here
daily_confirmed$Canada[min(which(is.na(daily_confirmed$Canada)))] <- 4038L
...
# TODO integrate ontario data here
df_EU$confirmed[df_EU$Country.Region == "Canada"] <- 4038L
df_EU$death[df_EU$Country.Region == "Canada"] <- 119L
df_EU$unrecovered[df_EU$Country.Region == "Canada"] <- 3919L
...
# TODO integrate ontario data
cv_data_for_plot$cases[cv_data_for_plot$Province.State == "Ontario" & cv_data_for_plot$type == "confirmed"] <- 4038L

cv_data_for_plot$cases[cv_data_for_plot$Province.State == "Ontario" & cv_data_for_plot$type == "death"] <- 119L
